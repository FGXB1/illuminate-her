export type NodeType = "investor" | "company" | "building"
...
export const gameNodes: GameNode[] = [
  {
    ...
    type: "investor",
    description:
      "You meet Alex, a well-known angel investor. They offer to show you the trading floor.",
    choices: [
  ...
  },
  {
    ...
    type: "company",
    description:
      "Breaking news: this fintech startup just disrupted the payments industry. The market reacts swiftly.",
    choices: [
  ...
  },
  {
    ...
    type: "investor",
    description:
      "You meet Maya, a junior VC partner pulling an all-nighter on a pitch book for a big deal.",
    choices: [
  ...
  },
  {
    ...
    type: "building",
    description:
      "You stand on the bustling trading floor. Screens flash with live data and traders shout orders.",
    choices: [
  ...
  {
    id: 6,
    label: "Growing Retail Co",
    type: "company",
    description:
      "A fast-growing retail company is expanding nationwide. Their stock is surging on the news.",
    choices: [
      { label: "Learn about growth", outcome: "You understand revenue scaling vs. profit margins." },
      { label: "Ask about strategy", outcome: "You learn about competitive moats in retail." },
    ],
    glossaryTerms: [
  ...
  },
  {
    ...
    type: "investor",
    description:
      "A seasoned Portfolio Manager invites you to sit in on a client call. This is a rare opportunity.",
    choices: [
      { label: "Join the call", outcome: "You see how senior managers negotiate with CEOs." },
      { label: "Take notes", outcome: "You learn how deals are structured from the top." },
      { label: "Ask for advice", outcome: "The PM shares their career journey with you." },
    ],
    glossaryTerms: [
  ...
  },
  {
    ...
    type: "company",
    description:
      "A hot biotech company is going public today! The excitement is electric on the trading floor.",
    choices: [
  ...
  {
    id: 10,
    label: "Hedge Fund Mgr",
    type: "investor",
    description:
      "Rashid runs a top hedge fund, making split-second decisions. He challenges you to a mock trade.",
    choices: [
  ...
  },
  {
    ...
    type: "building",
    description:
      "You arrive at the financial news headquarters. Breaking stories move markets in seconds.",
    choices: [
      { label: "Read the headlines", outcome: "You see how news drives stock price movements." },
  ...
  },
  {
    ...
    type: "company",
    description:
      "Congratulations! Your team just closed a $2B tech IPO. You helped make it happen!",
    choices: [
      { label: "Celebrate!", outcome: "You've completed the Wall Street Walk. Well done!" },
      { label: "Review the deal", outcome: "You analyze how the IPO was structured." },
    ],
    glossaryTerms: [
