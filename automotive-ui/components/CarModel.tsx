...
export default function CarModel({ onPartClick, isRacing = false }: CarModelProps) {
  ...
  return (
    <group ref={groupRef} dispose={null}>
      ...
      {/* Interactive Labels (Only visible when hovering or specific state?) - For now just relying on color change */}
    </group>
  );
}
